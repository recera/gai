...
func (p *Provider) StreamText(ctx context.Context, req core.Request) (core.TextStream, error) {
	...
	streamResult, err := obs.WithGenAIStreamingObservability(ctx, "openai", model, obs.GenAIOpStreamCompletion, req, func(ctx context.Context) (interface{}, error) {
...
func (p *Provider) StreamObject(ctx context.Context, req core.Request, schema any) (core.ObjectStream[any], error) {
	...
	// Use streaming GenAI observability wrapper
	streamResult, err := obs.WithGenAIStreamingObservability(ctx, "openai", model, obs.GenAIOpStreamObjectCompletion, req, func(ctx context.Context) (interface{}, error) {
